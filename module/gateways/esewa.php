 ...
 *
 * @see https://github.com/yubrajpandeya/whmcs-esewa-module
 *
...
function esewa_config()
{
    return array(
        ...
        'SecretKey' => array(
            ...
            'Type' => 'password',
            'Size' => '50',
            'Default' => 'IgEAFhUWGUU3AAMEG0E+DgEQBFM1ARVdJxEdS0krJ0w2OEg+NzYkIyQhJTU=',
...
function esewa_link($params)
{
    ...
    $secretKey = $params['SecretKey']; // Added secret key
    ...
    $postfields['sk'] = $secretKey; // Pass secret key
