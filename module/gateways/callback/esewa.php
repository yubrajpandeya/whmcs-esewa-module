 ...
 *
 * @see https://github.com/yubrajpandeya
 *
 * @copyright Copyright (c) Yubraj Pandeya
 * @author : @Yubraj Pandeya
 */
...
# Retrieve the eSewa secret key from configuration, with a default value
$secretKey = isset($gatewayParams['SecretKey']) && !empty($gatewayParams['SecretKey']) 
...
if ($invoice->total != $paymentAmount) {
    ...
    $paymentData = [
        ...
        'secret_key' => $secretKey,  // Add secret key to the payment data
    ];
